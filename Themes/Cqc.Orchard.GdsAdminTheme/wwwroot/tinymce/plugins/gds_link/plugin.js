...
(function (domGlobals) {
        ...
        var body = {
            ...
            items: flatten([
                ...
                cat([
                    ...
                    catalogs.link.map(ListOptions.createUi('gds_link', 'Link list')),
    ...
    var register = function (editor) {
        editor.addCommand('gds_link', function () {
    ...
    var setup = function (editor) {
        editor.addShortcut('Meta+K', '', function () {
            editor.execCommand('gds_link');
        });
    };

    var setupButtons = function (editor) {
        editor.ui.registry.addToggleButton('gds_link', {
            icon: 'link',
            tooltip: 'Insert/edit link',
            onAction: openDialog(editor),
            onSetup: toggleActiveState(editor)
        });
        editor.ui.registry.addButton('gdsOpenLink', {
            icon: 'new-tab',
            tooltip: 'Open link',
            onAction: gotoSelectedLink(editor),
            onSetup: toggleEnabledState(editor)
        });
        editor.ui.registry.addButton('gds_unlink', {
            icon: 'unlink',
            tooltip: 'Remove link',
            onAction: function () {
    ...
    var setupMenuItems = function (editor) {
        editor.ui.registry.addMenuItem('gdsOpenLink', {
            text: 'Open link',
            icon: 'new-tab',
            onAction: gotoSelectedLink(editor),
            onSetup: toggleEnabledState(editor)
        });
        editor.ui.registry.addMenuItem('gds_link', {
            icon: 'link',
            text: 'Link...',
            shortcut: 'Meta+K',
            onAction: openDialog(editor)
        });
        editor.ui.registry.addMenuItem('gds_unlink', {
            icon: 'unlink',
            text: 'Remove link',
            onAction: function () {
                return unlink(editor);
    ...
    var setupContextMenu = function (editor) {
        ...
        var noLink = 'link';
        editor.ui.registry.addContextMenu('gds_link', {
    ...
    function Plugin() {
        global.add('gds_link', function (editor) {
            setupButtons(editor);
