...
(function (domGlobals) {
    ...
    var register$1 = function (editor) {
      ...
      if (!hasPlugin(editor, 'advlist')) {
        editor.ui.registry.addToggleButton('gds_numlist', {
          icon: 'ordered-list',
          active: false,
        ...
        editor.ui.registry.addToggleButton('gds_bullist', {
          icon: 'unordered-list',
          active: false,
          tooltip: 'Bullet list',
    ...
    var register$2 = function (editor) {
      ...
      editor.ui.registry.addContextMenu('gds_lists', {
    ...
    function Plugin () {
        global.add('gds_lists', function (editor) {
